...
import { LuUser, LuMail, LuLock, LuTrendingUp } from 'react-icons/lu';
        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-900 px-4">
            <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700 p-8 rounded-3xl w-full max-w-md shadow-2xl">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-400 text-sm mt-1">Get started with InsightX Analytics</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            <span className="absolute left-3.5 top-3.5 text-slate-500"><LuUser size={18} /></span>
                            <input
                                type="text"
                                required
                                value={name}
                    ...
                    <div>
                        <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Select Role</label>
                        <select
                            value={role}
                            onChange={(e) => setRole(e.target.value)}
                            className="w-full px-4 py-3 rounded-xl border border-slate-700 bg-slate-900/50 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        >
